                    ...
                    <div
                      ...
                      <div class="d-table scale-up delay-4 mx-auto mx-md-0">
                        <a
                          ...
                          >Shop Now<i class="ci-arrow-right ms-2 me-n1"></i
                        ></a>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  <div class="row align-items-center">
                    ...
                    <div
                      ...
                      <h1 class="display-4 from-start delay-1">
                        VR Collection
                      </h1>
                      <h5 class="fw-light pb-3 from-start delay-2">
                        on the market
                      </h5>
                      <div class="d-table scale-up delay-4 mx-auto mx-md-0">
                        <a
            ...
            <div class="table-responsive" data-simplebar>
              <div class="d-flex d-xl-block">
                <a
                  ...
                  <div class="py-4 px-2">
                    <h5 class="mb-2">
                      <span class="fw-light">Next Gen</span><br />Video
                      <span class="fw-light">with</span><br />360 Cam
                    </h5>
                ...
                ><a
                  ...
                  <div class="py-4 px-2">
                    <h5 class="mb-2">
                      <span class="fw-light">Top Rated</span
                      ><br />Gadgets<br /><span class="fw-light">are on </span
                      >Sale
                    </h5>
                ...
                ><a
                  class="d-flex align-items-center bg-faded-success rounded-3 pt-2 ps-2 mb-4"
                  href="#"
                  style="min-width: 16rem"
                  ><img
                  ...
                  <div class="py-4 px-2">
                    <h5 class="mb-2">
                      <span class="fw-light">Catch Big</span><br />Deals
                      <span class="fw-light">on</span><br />Earbuds
                    </h5>
      ...
      <div class="row pt-2 mx-n2">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
          <div class="card product-card">
            ...
            <div class="card-body py-2">
              <a class="product-meta d-block fs-xs pb-1" href="#">Headphones</a>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
          <div class="card product-card">
            ...
            <div class="card-body py-2">
              ...
              <div class="d-flex justify-content-between">
                <div class="product-price">
                  <span class="text-accent">$98.<small>50</small></span>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
          <div class="card product-card">
            ...
            <div class="card-body py-2">
              ...
              <div class="d-flex justify-content-between">
                <div class="product-price">
                  <span class="text-muted fs-sm">Out of stock</span>
                </div>
              </div>
            </div>
            <div class="card-body card-body-hidden">
              <a
                class="btn btn-secondary btn-sm d-block w-100 mb-2"
                href="shop-single-v2.html"
                >View details</a
              >
              <div class="text-center">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
          <div class="card product-card">
            ...
            /></a>
            <div class="card-body py-2">
              <a class="product-meta d-block fs-xs pb-1" href="#">Smart Home</a>
              <h3 class="product-title fs-sm">
                <a href="shop-single-v2.html"
                  >Smart Speaker with Voice Control</a
                >
              </h3>
              <div class="d-flex justify-content-between">
                <div class="product-price">
                  <span class="text-accent">$49.<small>99</small></span>
                </div>
                <div class="star-rating">
                  <i class="star-rating-icon ci-star-filled active"></i
                  ><i class="star-rating-icon ci-star-filled active"></i
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
          <div class="card product-card">
            ...
            <div class="card-body py-2">
              ...
              <div class="d-flex justify-content-between">
                <div class="product-price">
                  <span class="text-accent">$317.<small>40</small></span>
                </div>
                <div class="star-rating">
                  <i class="star-rating-icon ci-star-filled active"></i
                  ><i class="star-rating-icon ci-star-filled active"></i
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
          <div class="card product-card">
            ...
            <div class="card-body py-2">
              ...
              <div class="d-flex justify-content-between">
                <div class="product-price">
                  <span class="text-accent">$965.<small>00</small></span>
                </div>
                <div class="star-rating">
                  <i class="star-rating-icon ci-star-filled active"></i
                  ><i class="star-rating-icon ci-star-filled active"></i
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
          <div class="card product-card">
            ...
            <div class="card-body py-2">
              ...
              <h3 class="product-title fs-sm">
                <a href="shop-single-v2.html"
                  >Smart Watch Series 5, Aluminium</a
                >
              </h3>
              <div class="d-flex justify-content-between">
                <div class="product-price">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2">
          <div class="card product-card">
            ...
            <div class="card-body py-2">
              ...
              <div class="d-flex justify-content-between">
                <div class="product-price">
                  <span class="text-accent">$412.<small>00</small></span>
                </div>
              </div>
            </div>
            <div class="card-body card-body-hidden">
        ...
        <div class="row align-items-center">
          <div class="col-md-5">
            <div class="px-4 pe-sm-0 ps-sm-5">
              ...
              <p class="h5 text-body fw-light">
                at discounted price. Hurry up!
              </p>
              <div
                class="countdown py-2 h4"
              ...
              <a class="btn btn-accent" href="#"
                >View offers<i class="ci-arrow-right fs-ms ms-1"></i
              ></a>
            </div>
          </div>
          <div class="col-md-7">
    ...
    <section class="container mb-5">
      <div class="tns-carousel border-end">
        <div
          ...
          <div>
            <a
              class="d-block bg-white border py-4 py-sm-5 px-2"
              href="#"
              style="margin-right: -0.0625rem"
              ><img
                class="d-block mx-auto"
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 mb-2 py-3">
          <div class="widget">
            ...
            <p class="mb-0">...</p>
            <a class="fs-sm" href="shop-grid-ls.html"
              >View more<i class="ci-arrow-right fs-xs ms-1"></i
            ></a>
          </div>
        </div>
        <!-- New arrivals-->
    ...
    <section class="container pb-5 mb-md-3">
      <div class="border rounded-3 p-3">
        <div class="row">
            ...
            <div class="bg-secondary p-5 text-center">
              ...
              <div
                ...
                <img
                  ...
                  width="126"
                  alt="YouTube Subscribers" /><span class="fs-sm">250k+</span>
              </div>
              <a
                class="btn btn-primary border-0 btn-sm mb-3"
                href="#"
                style="background-color: #ff0000"
                ><i class="ci-add-user me-2"></i>Subscribe*</a
              >
              <p class="fs-sm mb-0">
          ...
          <div class="col-md-8">
            <div
              class="d-flex flex-wrap justify-content-between align-items-center pt-3 pb-2">
              <h2 class="h4 mb-3">Latest videos from Cartzilla channel</h2>
              <a class="btn btn-outline-accent btn-sm mb-3" href="#"
                >More videos<i class="ci-arrow-right fs-xs ms-1 me-n1"></i
              ></a>
            </div>
            <div class="row g-0">
              <div class="col-lg-4 col-6 mb-3">
                <a
                  class="d-block text-decoration-0 px-2"
                  href="https://www.youtube.com/embed/vS93u75NnPo"
                  data-bs-toggle="video">
                  <div class="position-relative mb-2">
                    <span
                      class="badge bg-dark position-absolute bottom-0 end-0 mb-2 me-2"
                      >6:16</span
                    ><img
                      class="w-100"
