        ...
        <div class="modal-header">
          <h4 class="modal-title product-title">
            <a
              ...
              >Smartwatch Youth Edition<i class="ci-arrow-right fs-lg ms-2"></i
            ></a>
          </h4>
          <button
            class="btn-close"
            ...
            <div class="col-lg-5 pt-4 pt-lg-0 image-zoom-pane">
              <div class="product-details ms-auto pb-3">
                <div class="mb-2">
                  ...
                  <span
                    class="d-inline-block fs-sm text-body align-middle mt-1 ms-1"
                    >74 Reviews</span
                  >
                </div>
                ...
                <div class="fs-sm mb-4">
                  ...
                  ><span class="text-muted" id="colorOptionText"
                    >Dark blue/Orange</span
                  >
                </div>
                ...
                <ul class="fs-sm pb-2">
                  <li>
                    <span class="text-muted">Model: </span>Amazfit Smartwatch
                  </li>
                  <li><span class="text-muted">Gender: </span>Unisex</li>
                  <li>
                    <span class="text-muted">OS campitibility: </span>Android /
                    iOS
                  </li>
                </ul>
                ...
                <ul class="fs-sm pb-2">
                  ...
                  <li>
                    <span class="text-muted">Body material: </span>Plastics /
                    Ceramics
                  </li>
                  <li>
                    <span class="text-muted">Band material: </span>Silicone
                  </li>
                </ul>
              </div>
            </div>
